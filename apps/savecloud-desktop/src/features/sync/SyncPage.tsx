        ...
        <Card className="border border-warning-200 bg-warning-50/50 dark:border-warning-800 dark:bg-warning-900/20">
          <CardBody className="gap-2">
            <p className="text-warning-700 dark:text-warning-400">
              Para usar la nube necesitas configurar <strong>URL</strong>, <strong>usuario</strong> y{" "}
              <strong>clave</strong>. El archivo <code className="rounded bg-default-100 px-1">config.json</code> debe
