...
export function GameCardStatsPanel({ stats, editionLabel }: GameCardStatsPanelProps) {
  return (
    <div className="absolute inset-0 bg-[#0d0e12]/95 border-t border-white/5 p-3 flex flex-col justify-center gap-1.5 z-20 translate-y-full group-hover:translate-y-0 transition-transform duration-350 ease-out rounded-b-[10px] subpixel-antialiased">
