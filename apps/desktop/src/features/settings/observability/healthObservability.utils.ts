...
export const SEVERITY_VISUAL: Record<ObservabilitySeverity, SeverityVisual> = {
  ok: {
    label: "OPERATIVO",
    detail: "telemetría dentro de umbrales",
  ...
  warning: {
    label: "DEGRADADO",
    detail: "indicadores fuera de objetivo",
