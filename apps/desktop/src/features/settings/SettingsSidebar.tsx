...
export function SettingsSidebar({ tabs, selectedTab, onSelectTab }: SettingsSidebarProps) {
  ...
  const getTabLabel = (key: string, defaultLabel: string) => {
    switch (key) {
      ...
      case "plugins":
        return t("settings.tabs.plugins");
      case "updates":
