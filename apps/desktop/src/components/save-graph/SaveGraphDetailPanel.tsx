    ...
    return (
      <Card className="border border-divider bg-content1">
        <CardBody className="space-y-3 p-5">
          <p className="text-[10px] font-semibold uppercase tracking-[0.28em] text-default-500">Detalle</p>
          <div className="flex items-start gap-3">
            ...
            <div className="space-y-1">
              <h3 className="text-base font-semibold">Nada seleccionado</h3>
      ...
      <CardBody className="space-y-4 p-5">
        <div className="flex items-start gap-3">
          ...
          <div className="min-w-0 space-y-1">
            <p className="text-[10px] font-semibold uppercase tracking-[0.28em] text-default-500">Nodo</p>
            <h3 className="truncate text-lg font-semibold text-foreground">{node.title}</h3>
            <p className="text-sm text-default-500">{node.subtitle ?? "Sin subtítulo"}</p>
          </div>
        </div>

        <div className="grid grid-cols-1 gap-3 sm:grid-cols-2">
          <div className="rounded-[18px] border border-divider bg-content2 p-3">
            <p className="text-[10px] font-semibold uppercase tracking-[0.28em] text-default-500">Tipo</p>
            <p className="mt-1 text-sm font-semibold">{node.kind}</p>
          </div>
          <div className="rounded-[18px] border border-divider bg-content2 p-3">
            <p className="text-[10px] font-semibold uppercase tracking-[0.28em] text-default-500">Métrica</p>
            <p className="mt-1 text-sm font-semibold">{node.metric ?? "Sin métricas"}</p>
          </div>
          <div className="rounded-[18px] border border-divider bg-content2 p-3">
            <p className="text-[10px] font-semibold uppercase tracking-[0.28em] text-default-500">Estado</p>
            <p className="mt-1 text-sm font-semibold">{node.status ?? "Sin estado"}</p>
          </div>
          <div className="rounded-[18px] border border-divider bg-content2 p-3">
            <p className="text-[10px] font-semibold uppercase tracking-[0.28em] text-default-500">Juego</p>
            <p className="mt-1 text-sm font-semibold">{node.gameId ?? "Biblioteca"}</p>
          </div>
        </div>
