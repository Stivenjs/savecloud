...
const LinuxLogo = () => (
  <svg
    viewBox="0 0 24 24"
    fill="currentColor"
    className="w-7.5 h-7.5 inline-block mr-2 text-foreground align-text-bottom"
...
export default function Downloads() {
  ...
  return (
    <section id="downloads" className="border-b border-divider py-16 px-6 md:px-12 scroll-mt-6">
      <div className="mb-16">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-12 lg:gap-16">
        {/* macOS */}
        <div className="flex flex-col justify-between min-h-87.5">
          <div>
